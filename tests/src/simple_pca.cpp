...
TEST_P(SimplePcaBasicTest, Test) {
    ...
    opt.scale = scale;
    auto ref = scran_pca::simple_pca(dense_row.get(), rank, opt);
    ...
    if (threads == 1) {
        ...
        auto res1 = scran_pca::simple_pca(dense_row.get(), rank, opt);
    ...
    auto res2 = scran_pca::simple_pca(dense_column.get(), rank, opt);
    ...
    auto res3 = scran_pca::simple_pca(sparse_row.get(), rank, opt);
    ...
    auto res4 = scran_pca::simple_pca(sparse_column.get(), rank, opt);
    ...
    auto tres1 = scran_pca::simple_pca(dense_row.get(), rank, opt);
    ...
    auto tres2 = scran_pca::simple_pca(dense_column.get(), rank, opt);
    ...
    auto tres3 = scran_pca::simple_pca(sparse_row.get(), rank, opt);
    ...
    auto tres4 = scran_pca::simple_pca(sparse_column.get(), rank, opt);
...
TEST_P(SimplePcaMoreTest, ZeroVariance) {
    ...
    auto raw_init = scran_tests::simulate_vector(nr * nc, [&]() {
        scran_tests::SimulationParameters sparams;
        sparams.lower = -2;
        sparams.upper = 2;
    ...
    auto spout = scran_pca::simple_pca(sparse_zero.get(), rank, opt);
